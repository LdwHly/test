...
import com.ldw.test.socketclienttest.BuildConfig;
import com.ldw.test.socketclienttest.LogLog;

public class ParentsView2 extends RelativeLayout {
    public final String TAG = ParentsView2.class.getSimpleName();

    public ParentsView2(Context context) {
        super(context);
    }

    public ParentsView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ParentsView2(Context context, AttributeSet attrs, int defStyleAttr) {
